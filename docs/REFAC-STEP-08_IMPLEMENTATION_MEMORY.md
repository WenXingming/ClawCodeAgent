...
1. `docs/Architecture.md`：控制面与查询门面更新为 `app/*`。
2. `docs/TEST_MATRIX.md`：高风险链路测试路径更新为 `test/app/test_query_service.py`。
3. `docs/DEMO_SCRIPT.md`：示例导入切换到 `app.query_service.QueryService`。
