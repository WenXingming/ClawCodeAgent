...
根据 [docs/architecture/GLOBAL_REFACTOR_PLAN.md](/docs/architecture/GLOBAL_REFACTOR_PLAN.md) 的 Step 2，重建 session、CLI 与 resume 的静态契约装配路径，让新会话与恢复会话共用同一条启动规格构建链。
