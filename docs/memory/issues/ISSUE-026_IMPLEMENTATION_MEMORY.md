...
| 文件 | 变更类型 | 说明 |
|------|----------|------|
| `docs/release/TEST_MATRIX.md` | 新建 | 收敛单测、集成、smoke、失败场景与文档校验矩阵 |
| `docs/release/RELEASE_GATE_CHECKLIST.md` | 新建 | 发布门禁清单与结果模板 |
| `docs/release/DEMO_SCRIPT.md` | 新建 | 真实后端联调前的人工演示脚本 |
...
| `docs/architecture/FINAL_ARCHITECTURE_PLAN.md` | 修改 | 在 ISSUE-026 下记录已落地设计决策 |
...
需要真实后端的最终演示流程保留在 `docs/release/DEMO_SCRIPT.md` 中人工执行。
