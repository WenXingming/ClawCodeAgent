...
根据 [docs/GLOBAL_REFACTOR_PLAN.md](docs/GLOBAL_REFACTOR_PLAN.md) 的 Step 1，删除旧聚合运行配置对象与 `src/core_contracts/config.py`，把静态契约拆分为更小的领域对象。
...
尚未完成的下一阶段工作仍然属于 [docs/GLOBAL_REFACTOR_PLAN.md](docs/GLOBAL_REFACTOR_PLAN.md) 的 Step 2 及之后：
