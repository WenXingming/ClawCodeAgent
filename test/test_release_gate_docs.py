...
class ReleaseGateDocsTests(unittest.TestCase):
    def test_release_gate_artifacts_exist(self) -> None:
        expected_paths = (
            _ROOT / 'docs' / 'release' / 'TEST_MATRIX.md',
            _ROOT / 'docs' / 'release' / 'RELEASE_GATE_CHECKLIST.md',
            _ROOT / 'docs' / 'release' / 'DEMO_SCRIPT.md',
    ...
    def test_test_matrix_and_checklist_reference_release_commands(self) -> None:
        test_matrix = (_ROOT / 'docs' / 'release' / 'TEST_MATRIX.md').read_text(encoding='utf-8')
        checklist = (_ROOT / 'docs' / 'release' / 'RELEASE_GATE_CHECKLIST.md').read_text(encoding='utf-8')
    ...
    def test_demo_script_covers_cli_and_query_service_flows(self) -> None:
        demo_script = (_ROOT / 'docs' / 'release' / 'DEMO_SCRIPT.md').read_text(encoding='utf-8')
